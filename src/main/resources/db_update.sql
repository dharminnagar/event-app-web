...
(2, 6, 'Seaside Resort', 'Venue', 'Beautiful beachfront venue with panoramic views of the ocean. Featuring indoor and outdoor spaces, accommodating up to 200 guests with luxury accommodation options for out-of-town guests.', 'bookings@musicalentertainment.com', '555-678-9012', 'Mumbai, Maharashtra', 75000.00, 'https://images.unsplash.com/photo-1545569331-9a8a3521b4ce?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80', true, 4.7),
...
(8, 5, 'Blossom Décor', 'Decoration', 'Specializing in floral arrangements and themed decorations for all occasions. From minimalist modern designs to extravagant floral installations, customized to match your event\'s color scheme and theme.', 'orders@floraldesigns.com', '555-567-8901', 'Vadodara, Gujarat', 18000.00, 'https://images.unsplash.com/photo-1478146896981-b47f11bdce5f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80', true, 4.6),
...
-- Note: Syntax might vary based on your database system
-- For MySQL:
